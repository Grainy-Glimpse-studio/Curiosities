  ...
  return (
    ...
    >
      ...
      <div className="absolute inset-0 z-20">
        ...
        <div className="absolute inset-0 overflow-y-auto overflow-x-hidden pt-20 px-8 pb-8 scrollbar-hide z-10">
           <div className="flex flex-wrap gap-8 pb-32" style={{ minWidth: '2000px' }}>
             ...
             <motion.div
               ...
               style={{ width: cardSizes[cardSize] }}
             >
               <UploadTape
                 titleFont={titleFont}
